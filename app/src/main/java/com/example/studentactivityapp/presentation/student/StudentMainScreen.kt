...
import com.example.studentactivityapp.presentation.student.notifications.StudentNotificationsScreen
import com.example.studentactivityapp.presentation.student.pointshistory.StudentPointsHistoryScreen
...
fun StudentMainScreen(
    ...
    Scaffold(
        ...
        NavHost(
            ...
            composable(Screen.StudentProfile.route) {
                StudentProfileScreen(
                    ...
                    onPointsHistoryClick = {
                        navController.navigate(Screen.StudentPointsHistory.route)
                    },
            ...
            composable(Screen.StudentPointsHistory.route) {
                StudentPointsHistoryScreen(
                    innerPadding = innerPadding,
                    onBackClick = { navController.popBackStack() }
                )
            }
